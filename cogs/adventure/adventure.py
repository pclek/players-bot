...
def roll_adventure_result(job_type: str, current_hp: int, user_level: int = 1):
    if job_type == "fishing":
        results = [
            ...
            # 총합 1000 기준
            # 꽝 25%, 황금잉어 1.4%, 심해어 0.7%, 전설의심해어 0.5%
            ("item", "🐟 붕어를 낚았습니다!", "붕어", 1, 186),
            ("item", "🐟 고등어를 낚았습니다!", "고등어", 1, 155),
            ("item", "🐟 연어를 낚았습니다!", "연어", 1, 124),
            ("item", "🐟 참치를 낚았습니다!", "참치", 1, 93),
            ("item", "🐍 장어를 낚았습니다!", "장어", 1, 72),
            ("item", "🐙 문어를 낚았습니다!", "문어", 1, 52),
            ("item", "🐡 복어를 낚았습니다!", "복어", 1, 42),
            ("item", "✨ 황금잉어를 낚았습니다!", "황금잉어", 1, 14),
            ("item", "🌊 심해어를 낚았습니다!", "심해어", 1, 7),
        ...
        # 총합 250
        fail_results_25 = [
            ("none", "💥 광산이 살짝 무너졌습니다.\n아무것도 얻지 못했습니다.", None, 0, 45),
            ("none", "💥 크리퍼와 만나 도망쳤습니다.\n아무것도 얻지 못했습니다.", None, 0, 45),
            ("none", "🪨 하루 종일 돌만 캤습니다.\n돌도 자원이라지만 오늘은 아닙니다.", None, 0, 40),
            ("none", "🦇 박쥐 떼가 지나가 작업을 중단했습니다.", None, 0, 35),
            ("none", "💨 먼지만 잔뜩 마셨습니다.\n성과는 없고 기침만 남았습니다.", None, 0, 30),
            ("none", "💎 반짝이는 걸 발견했지만 그냥 유리 조각이었습니다.", None, 0, 30),
        ]

        if current_hp > 2:
            fail_results_25.append(
                ("hp", "🤕 곡괭이질을 하다 허리를 삐끗했습니다.\nHP가 `2` 감소했습니다.", None, 2, 25)
            )
        else:
            fail_results_25.append(
                ("none", "🤕 허리를 삐끗할 뻔했지만 겨우 버텼습니다.\n체력이 낮아 작업을 중단했습니다.", None, 0, 25)
            )

        # 광산 실패 결과 15%
        # 총합 150
        fail_results_15 = [
            ("none", "💥 광산이 살짝 무너졌습니다.\n아무것도 얻지 못했습니다.", None, 0, 28),
            ("none", "💥 크리퍼와 만나 도망쳤습니다.\n아무것도 얻지 못했습니다.", None, 0, 28),
            ("none", "🪨 하루 종일 돌만 캤습니다.\n돌도 자원이라지만 오늘은 아닙니다.", None, 0, 25),
            ("none", "🦇 박쥐 떼가 지나가 작업을 중단했습니다.", None, 0, 22),
            ("none", "💨 먼지만 잔뜩 마셨습니다.\n성과는 없고 기침만 남았습니다.", None, 0, 17),
            ("none", "💎 반짝이는 걸 발견했지만 그냥 유리 조각이었습니다.", None, 0, 15),
        ]

        if current_hp > 2:
            fail_results_15.append(
                ("hp", "🤕 곡괭이질을 하다 허리를 삐끗했습니다.\nHP가 `2` 감소했습니다.", None, 2, 15)
            )
        else:
            fail_results_15.append(
                ("none", "🤕 허리를 삐끗할 뻔했지만 겨우 버텼습니다.\n체력이 낮아 작업을 중단했습니다.", None, 0, 15)
            )


        if user_level >= 45:
            results = fail_results_15 + [
                ("item", "🪨 석탄을 캤습니다!", "석탄", random.randint(1, 3), 220),
                ("item", "🟤 구리광석을 캤습니다!", "구리광석", random.randint(1, 2), 170),
                ("item", "⚙️ 철광석을 캤습니다!", "철광석", random.randint(1, 2), 200),
                ("item", "🥈 은광석을 캤습니다!", "은광석", random.randint(1, 2), 125),
                ("item", "🥇 금광석을 캤습니다!", "금광석", random.randint(1, 2), 60),
                ("item", "🔷 미스릴광석을 캤습니다!", "미스릴광석", 1, 35),
                ("item", "💎 다이아원석을 발견했습니다!", "다이아원석", 1, 28),
                ("item", "⚫ 흑철광석을 발견했습니다!", "흑철광석", 1, 21),
                ("item", "🟣 비브라늄원석을 발견했습니다!", "비브라늄원석", 1, 14),
                ("item", "🌈 오리하르콘광석을 발견했습니다!", "오리하르콘광석", 1, 7),
            ]

        elif user_level >= 36:
            results = fail_results_15 + [
                ("item", "🪨 석탄을 캤습니다!", "석탄", random.randint(1, 3), 230),
                ("item", "🟤 구리광석을 캤습니다!", "구리광석", random.randint(1, 2), 200),
                ("item", "⚙️ 철광석을 캤습니다!", "철광석", random.randint(1, 2), 220),
                ("item", "🥈 은광석을 캤습니다!", "은광석", random.randint(1, 2), 200),
                ("item", "🥇 금광석을 캤습니다!", "금광석", random.randint(1, 2), 50),
                ("item", "🔷 미스릴광석을 캤습니다!", "미스릴광석", 1, 28),
                ("item", "💎 다이아원석을 발견했습니다!", "다이아원석", 1, 21),
                ("item", "⚫ 흑철광석을 발견했습니다!", "흑철광석", 1, 14),
                ("item", "🟣 비브라늄원석을 발견했습니다!", "비브라늄원석", 1, 7),
            ]

        elif user_level >= 27:
            results = fail_results_15 + [
                ("item", "🪨 석탄을 캤습니다!", "석탄", random.randint(1, 3), 240),
                ("item", "🟤 구리광석을 캤습니다!", "구리광석", random.randint(1, 2), 230),
                ("item", "⚙️ 철광석을 캤습니다!", "철광석", random.randint(1, 2), 240),
                ("item", "🥈 은광석을 캤습니다!", "은광석", random.randint(1, 2), 198),
                ("item", "🥇 금광석을 캤습니다!", "금광석", random.randint(1, 2), 40),
                ("item", "🔷 미스릴광석을 캤습니다!", "미스릴광석", 1, 21),
                ("item", "💎 다이아원석을 발견했습니다!", "다이아원석", 1, 14),
                ("item", "⚫ 흑철광석을 발견했습니다!", "흑철광석", 1, 7),
            ]

        elif user_level >= 18:
            results = fail_results_25 + [
                ("item", "🪨 석탄을 캤습니다!", "석탄", random.randint(1, 3), 230),
                ("item", "🟤 구리광석을 캤습니다!", "구리광석", random.randint(1, 2), 220),
                ("item", "⚙️ 철광석을 캤습니다!", "철광석", random.randint(1, 2), 190),
                ("item", "🥈 은광석을 캤습니다!", "은광석", random.randint(1, 2), 89),
                ("item", "🥇 금광석을 캤습니다!", "금광석", 1, 10),
                ("item", "🔷 미스릴광석을 캤습니다!", "미스릴광석", 1, 14),
                ("item", "💎 다이아원석을 발견했습니다!", "다이아원석", 1, 7),
            ]

        elif user_level >= 9:
            results = fail_results_25 + [
                ("item", "🪨 석탄을 캤습니다!", "석탄", random.randint(1, 3), 240),
                ("item", "🟤 구리광석을 캤습니다!", "구리광석", random.randint(1, 2), 270),
                ("item", "⚙️ 철광석을 캤습니다!", "철광석", random.randint(1, 2), 170),
                ("item", "🥈 은광석을 캤습니다!", "은광석", 1, 53),
                ("item", "🥇 금광석을 캤습니다!", "금광석", 1, 10),
                ("item", "🔷 미스릴광석을 캤습니다!", "미스릴광석", 1, 7),
            ]

        else:
            results = fail_results_25 + [
                ("item", "🪨 석탄을 캤습니다!", "석탄", random.randint(1, 3), 250),
                ("item", "🟤 구리광석을 캤습니다!", "구리광석", random.randint(1, 2), 300),
                ("item", "⚙️ 철광석을 캤습니다!", "철광석", 1, 150),
                ("item", "🥈 은광석을 캤습니다!", "은광석", 1, 40),
                ("item", "🥇 금광석을 캤습니다!", "금광석", 1, 10),
            ]
        ...
        results = [
            ...
            ("item", "🥔 감자를 수확했습니다!", "감자", 1, 180),
            ("item", "🌽 옥수수를 수확했습니다!", "옥수수", 1, 160),
            ("item", "🧅 양파를 수확했습니다!", "양파", 1, 140),
            ("item", "🧄 마늘을 수확했습니다!", "마늘", 1, 120),
            ("item", "🌿 허브를 수확했습니다!", "허브", 1, 100),
            ("item", "🌶 고추를 수확했습니다!", "고추", 1, 80),
            ("item", "🥕 당근을 수확했습니다!", "당근", 1, 70),
            ("item", "🍄 버섯을 수확했습니다!", "버섯", 1, 60),
            ("item", "🍚 쌀을 수확했습니다!", "쌀", 1, 40),
            ("item", "✨ 황금호박을 수확했습니다!", "황금호박", 1, 10),
        ]

    total_weight = sum(r[4] for r in results)
